...
alias default_folder_fix='xdg-mime default org.gnome.Nautilus.desktop inode/directory'
...
#alias fixaddtog1="sudo usermod -a -G docker $USER"
#alias fixaddtog2="sudo usermod -a -G wheel $USER"
#alias fixaddtog3="sudo usermod -a -G vboxusers $USER"
#alias fixaddtog4="sudo usermod -a -G gamemode $USER"
